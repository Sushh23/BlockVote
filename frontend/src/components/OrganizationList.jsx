...
const VotingPage = ({ organization, candidates, onVote, onBack, hasVoted }) => {
  ...
  return (
    <div className="full-screen-container pt-24 pb-12 text-white font-body">
      <GlobalStyles />
      <div className="bg-grid-overlay"></div>

      <div className="full-width-content mx-auto relative z-10">
        {/* Back Button */}
        <button
          onClick={onBack}
        ...
        {candidates.length === 0 ? (
          ...
          <div className="full-width-grid mb-12">
...
const AdminDashboard = ({ organizations, onAddOrganization, onAddCandidate, onBack }) => {
  ...
  // --- Rendering ---
  return (
    <div className="full-screen-container pt-12 pb-24 bg-black text-white font-body">
      <GlobalStyles />
      <div className="bg-grid-overlay"></div>
      ...
      <div className="admin-full-layout">
        {/* Sidebar */}
        <div className="bg-[var(--color-card-bg)] border-r border-gray-800 p-6">
          <div className="mb-10">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-extrabold font-main text-white mb-1 tracking-wider">
                  ADMIN CONSOLE
                </h2>
                <p className="text-gray-400 text-sm font-body">Manage voting organizations and candidates</p>
              </div>
            </div>
          </div>
          ...
          <nav className="space-y-2">
            <button
              ...
              className={`w-full text-left p-4 rounded-lg transition-all group border-2 ${activeForm === 'org' ? 'border-primary-accent bg-[var(--color-primary)]/10' : 'border-transparent hover:border-primary-accent/50'}`}
            >
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center group-hover:bg-[var(--color-primary)]/20 transition-colors border border-gray-700/50">
                  <svg className={`w-5 h-5 text-primary-accent transition-colors ${activeForm === 'org' ? 'text-white' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={3}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                  </svg>
                </div>
                <div className="text-left">
                  <h3 className="text-lg font-bold mb-1 font-body text-white">Add Organization</h3>
                  <p className="text-gray-400 text-xs font-body">Create a new voting sector</p>
                </div>
              </div>
            </button>
            ...
            <button
              ...
              disabled={orgCount === 0}
              className={`w-full text-left p-4 rounded-lg transition-all group border-2 ${activeForm === 'candidate' && orgCount > 0 ? 'border-primary-accent bg-[var(--color-primary)]/10' : 'border-transparent hover:border-primary-accent/50'} ${orgCount === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center group-hover:bg-[var(--color-primary)]/20 transition-colors border border-gray-700/50">
                  <svg className={`w-5 h-5 text-primary-accent transition-colors ${activeForm === 'candidate' ? 'text-white' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                  </svg>
                </div>
                <div className="text-left">
                  <h3 className="text-lg font-bold mb-1 font-body text-white">Add Candidate</h3>
                  <p className="text-gray-400 text-xs font-body">Add a candidate to an organization</p>
                </div>
              </div>
            </button>
            ...
            <button
              onClick={onBack}
              className="w-full text-left p-4 rounded-lg transition-all group border-2 border-transparent hover:border-gray-600 mt-8"
            >
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center group-hover:bg-gray-700/20 transition-colors border border-gray-700/50">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                  </svg>
                </div>
                <div className="text-left">
                  <h3 className="text-lg font-bold mb-1 font-body text-white">Back to Voting</h3>
                  <p className="text-gray-400 text-xs font-body">Return to main voting area</p>
                </div>
              </div>
            </button>
          </nav>
        ...
        <div className="p-8 overflow-y-auto">
          {/* --- FORM CONTAINER --- */}
          <div className="bg-[var(--color-dark-bg)] p-6 rounded-lg shadow-inner border border-gray-800 mb-8">
